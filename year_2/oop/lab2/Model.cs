...
{
    /// <summary>
    /// Class, that represents a Model - main instance in the game.
    ...
    public class Model
    {
        ...
        protected double PosX
        {
            ...
            set
            {
                this.posX = (GameUtils.checkIfPositionIsFree(posX: posX)) ? value : 0;
            }
        }
        ...
        protected double PosY
        {
            ...
            set
            {
                this.posY = (GameUtils.checkIfPositionIsFree(posY: posY)) ? value : 0;
            }
        }
            ...
            : this()
        {
            ...
            this.PosX = posX;
            this.PosY = posY;
            Logger.printMsgSystem(String.Format("Coordinates of model {0}: ({1};{2}).", this.Name, this.PosX, this.PosY));
        }
        ...
        public override string ToString()
        {
            return String.Format(
                "Id: {0}. Name of model: {1}. Coord:({2}:{3}). Health:{4}.",
                "id" + Id,
                this.Name,
                this.PosX, this.PosY,
                this.Health
