...
public class BaseTranslatorTest {
	...
	public void invalidInputTests() {
		int[] empty = {};
		int[] emptyExpected = {};
		assertArrayEquals(emptyExpected,
				BaseTranslator.convertBase(empty, 2, 10, 2));
	...
	public void binToOtherTests() {
		...
		assertArrayEquals(input,
				BaseTranslator.convertBase(input, 2, 2, input.length));
		assertArrayEquals(base4,
				BaseTranslator.convertBase(input, 2, 4, base4.length));
		assertArrayEquals(base8,
				BaseTranslator.convertBase(input, 2, 8, base8.length));
		assertArrayEquals(base13,
				BaseTranslator.convertBase(input, 2, 13, base13.length));
	...
	public void decToOtherTranslatorTest() {
		...
		int[] pi10 = { 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8, 9, 7, 9, 3, 2, 3, 8, 4,
				6, 2, 6 };
		int[] base16 = { 2, 4, 3, 15, 6, 10, 8, 8, 8, 5, 10 };
		assertArrayEquals(base16, BaseTranslator.convertBase(pi10, 10, 16, 11));
